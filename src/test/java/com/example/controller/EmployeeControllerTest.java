...
import com.example.empmanagement.controller.EmployeeController;
...
public class EmployeeControllerTest {
    ...
    @Test
    public void testGivenEmployeeObject_whenCreateEmployee_thenReturnSavedEmployee() throws Exception {
        given(employeeService.saveEmployee(any(Employee.class))).will((invocation) -> invocation.getArgument(0));
